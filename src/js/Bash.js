    ...
    constructor(target, options) {
        ...
        if (target instanceof Element) {
            ...
            if (options === undefined) {
                ...
                this.commandLineSign = this.options.sign;
            ...
            /* check if the developer provided defaultCommand argument.*/
            if (options.defaultCommands === undefined || options.defaultCommands=== true) {
                ...
                this.commands = [
                    ...
                    },
                    {
                        ...
                        function: this.clear,
                        description:
                            "Clears everything on the screen. Used when you want to start fresh.✨",
                    },
            ...
            }else if(options.defaultCommands === false){
                this.commands = [
                    {
                        name: "help",
                        function: this.help,
            ...
            this.commandLine.input.addEventListener("keydown", (e) => {
                if (e.key === "Enter") {
                    ...
                    if (userInput.length === 0) {
                        ...
                        new OutPut(
                            this.contentWrap,
                            `<p class="current-path">${this.fileSystem.printPath()}/</p>`
                        );
...
at: #${this.name}`);
     ...
     */
    outPut(content) {
        new OutPut(this.contentWrap, `${this.commandLineSign} ${content}`);
        this.contentWrap.appendChild(this.commandLine.element);
        this.commandLine.input.focus();
    }
